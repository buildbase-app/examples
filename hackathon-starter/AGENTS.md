...
| BuildBase sign-in, session, account CRUD                           | `config/buildbase.js`, `controllers/user.js`, `models/User.js`, `models/Session.js`                                                               |
...
| Auth views                                                         | `views/account/login.pug` (one button to the hosted page), `views/account/profile.pug`                                                            |
