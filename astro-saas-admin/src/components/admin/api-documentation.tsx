    ...
    <div className="space-y-4">
      <Card className={cn("space-y-4")}>
        <CardHeader>
          ...
          <CardDescription>
            {/* Changed for the BuildBase example. */}
            In the browser, the admin's own requests carry your BuildBase
            session: members of the admin workspace can read, and its admins and
            editors can write. Machine clients pass the API token as a request
            header instead. The API token is configured using{" "}
            <a
