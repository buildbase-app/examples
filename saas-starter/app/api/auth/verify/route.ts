...
import { SERVER_URL, SESSION_COOKIE } from '@/lib/buildbase';

/**
 * The hosted sign-in page redirects back with a one-time `code`; it is
 * exchanged for a session here, so the client secret never reaches the browser.
 */
