...
> **BuildBase example.** This page describes upstream's email, JWT and social auth, which this example replaces with BuildBase. See [the README](../README.md#how-sign-in-works-here).
