// Modified from BearStudio/start-ui-web: public BuildBase settings.
...
export const envClient = createEnv({
  ...
  client: {
    ...
    // BuildBase (public): the React SDK in the browser needs them too.
    VITE_BUILDBASE_SERVER_URL: z.url().default('https://api.console.buildbase.app'),
    VITE_BUILDBASE_ORG_ID: z.string().optional(),
    VITE_BUILDBASE_CLIENT_ID: z.string().optional(),
  },
  runtimeEnv: {
    ...envMetaOrProcess,
