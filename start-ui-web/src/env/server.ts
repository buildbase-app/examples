// Modified from BearStudio/start-ui-web: BuildBase replaces GitHub OAuth.
...
export const envServer = createEnv({
  server: {
    ...
    // BuildBase: the org and client IDs are public (envClient); the secret
    // stays here. Optional, so the app boots before it is connected.
    BUILDBASE_CLIENT_SECRET: zOptionalWithReplaceMe(),
