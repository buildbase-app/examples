// Modified from vercel/chatbot for BuildBase: adds the payment_required (402) error for an empty credit balance.
...
export function getMessageByErrorCode(errorCode: ErrorCode): string {
  ...
  switch (errorCode) {
    ...
    case "payment_required:chat":
      return "You are out of credits. Buy more to keep chatting.";
