// Changed for the BuildBase example: users are seeded without a password,
// since BuildBase owns sign-in. Signing in through BuildBase with one of these
// emails adopts the seeded user and its roles.
