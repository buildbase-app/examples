...
> **BuildBase example.** This page describes upstream's own auth (passwords,
> GitHub, passkeys, 2FA), which this example replaces with BuildBase. See
> [the README](../README.md#how-sign-in-works-here) for how sign-in works here.
