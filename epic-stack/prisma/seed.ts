// Modified from epicweb-dev/epic-stack: no passwords or GitHub connections;
// people sign in through BuildBase.
import { faker } from '@faker-js/faker'
import { prisma } from '#app/utils/db.server.ts'
import { createUser, getNoteImages, getUserImages } from '#tests/db-utils.ts'
