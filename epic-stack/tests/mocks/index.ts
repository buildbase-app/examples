// Modified from epicweb-dev/epic-stack: the GitHub OAuth and pwned-passwords
// mocks went with the features BuildBase replaced.
import closeWithGrace from 'close-with-grace'
import { setupServer } from 'msw/node'
import { handlers as resendHandlers } from './resend.ts'
import { handlers as tigrisHandlers } from './tigris.ts'

export const server = setupServer(...resendHandlers, ...tigrisHandlers)
