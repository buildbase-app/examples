// Modified from epicweb-dev/epic-stack: email, 2FA, password, connections and
// passkeys are BuildBase's now; the SDK's screens replace their five pages.
...
import { z } from 'zod'
import { BuildBaseAccount } from '#app/components/buildbase-account.tsx'
	...
	return (
		<div className="flex flex-col gap-12">
			...
			<div className="col-span-full flex flex-col gap-6">
				<BuildBaseAccount email={loaderData.user.email} />
				<div>
					<Link
						reloadDocument
